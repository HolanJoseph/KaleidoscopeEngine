#pragma once
// These scancodes are taken value wise from SDL_scancode.h
// The purpose of mirroring the SDL scancodes is to allow me create
//	an input system that is independent of the lower level input api.

// The keycodes correspond to the USB HID Usage Tables version 1.12

// These keycodes are used by the input methods to query a key is pressed 
//	or is released. 
